...
const BookmarksPage = () => {
  ...
  const filteredBookmarks = bookmarks
    .filter(bookmark => 
      bookmark.sermonTitle.toLowerCase().includes(searchQuery.toLowerCase()) ||
      bookmark.paragraphContent.toLowerCase().includes(searchQuery.toLowerCase()) ||
      (bookmark.location && bookmark.location.toLowerCase().includes(searchQuery.toLowerCase()))
    )
    .sort((a, b) => {
      switch (sortBy) {
        case "newest":
  ...
  return (
    <div className={`h-screen p-6  overflow-y-scroll no-scrollbar ${
      isDarkMode ? "bg-background" : "bg-gray-50"
    }`}>
      {/* Receipt Header */}
      <div className={`max-w-4xl mx-auto mb-8 p-6 font-mono ${
        ...
        <div className={`grid grid-cols-2 gap-4 text-center mb-4 ${
          ...
          <div className={`p-3 border border-dashed ${
            isDarkMode ? "border-accent bg-stone-800" : "border-gray-400 bg-gray-50"
          }`}>
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className={`text-xs mt-3 pt-3 border-t border-dashed ${
                    isDarkMode ? "border-accent text-gray-500" : "border-gray-300 text-gray-500"
                  }`}>
                ...
                <AnimatePresence>
                  {showDeleteConfirm === bookmark.id && (
                    ...
                    >
                      <div className={`p-6 border-2 border-dashed font-mono text-center ${
                        isDarkMode 
      ...
      {/* Receipt Footer */}
      {filteredBookmarks.length > 0 && (
        <div className={`max-w-4xl mx-auto mt-8 p-4 text-center font-mono ${
          isDarkMode ? "bg-primary border-accent" : "bg-white border-gray-300"
        } border-2 border-dashed`}>
